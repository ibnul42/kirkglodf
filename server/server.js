...
const { initStorage, getUser, setUser } = require("./storage");
...
app.get("/mfa_qr_code", async (req, res) => {
  ...
  //totp/MfaDemo:username?algorithm=SHA1&digits=6&issuer=MfaDemo&period=30&secret=5CZ4UNFL54LOGJ24ZIWUHBY
