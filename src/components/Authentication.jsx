    ...
    return (
        <div className="flex flex-col items-between mb-12 mt-2 md:mt-8 md:flex-row">
            <div className="flex flex-col justify-between">
                <div className="">
                    ...
                    <div className="flex items-center justify-center md:justify-start">
                        <h4 className={`text-[#00152E] opacity-50 font-bold text-lg ml-0 mr-1 cursor-pointer ${phoneActive ? '!text-[#0C77FF] border-b-2 border-b-[#0C77FF] !opacity-100' : ''}`} onClick={() => {
                    ...
                    <div className="my-4 flex flex-col">
                                ...
                                <div className="my-4 flex flex-row items-center">
                                    <div className="flex w-80">
                                        {phoneActive ? (
                                            <>
                                                <span
                                                    className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 rounded-l-full border border-r-0 border-gray-300 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                                    +880
                                                </span>
                                                <input type="phone"
                                                    id="phone"
                        ...
                        {otpVerify ?
                            <div className="my-4 flex flex-row items-center">
                                ...
                                <div className="">
                                    <FaArrowAltCircleRight className="w-20 text-[42px] text-[#0C77FF] drop-shadow-2xl cursor-pointer" />
                                </div>
                            </div>
                            : null}
                    </div>
            ...
            <div className="flex flex-col mt-10 md:mt-0 mb-5 md:mb-0 justify-between">
                <div className="">
                    <img src={imageIcon} alt="alter" />
                </div>
                <div className="mt-5 md:mt-20 flex flex-col md:flex-row mx-0 md:mx-20">
